 ...
 * Description:       A modern, simple REST API–based WordPress plugin for Alexa flash briefing skills.
 * Version:           1.2.0
 * Author:            Gioxx (based on the original source code by Francesco Napoletano)
...
// Plugin version.
define( 'SIMPLEALEXA_VERSION', '1.2.0' );
